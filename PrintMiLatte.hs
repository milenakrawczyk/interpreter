...
-- | Pretty-printer for PrintMiLatte.
--   Generated by the BNF converter.

module PrintMiLatte where
...
instance Print Block where
  prt i e = case e of
    Block stmtorfns -> prPrec i 0 (concatD [doc (showString "{"), prt 0 stmtorfns, doc (showString "}")])

instance Print StmtOrFn where
  prt i e = case e of
    StmtS stmt -> prPrec i 0 (concatD [prt 0 stmt])
    StmtF topdef -> prPrec i 0 (concatD [prt 0 topdef])
  prtList _ [] = concatD []
  prtList _ (x:xs) = concatD [prt 0 x, prt 0 xs]
...
instance Print Stmt where
  prt i e = case e of
    ...
    ArrDecl type_ id arrbrs -> prPrec i 0 (concatD [prt 0 type_, prt 0 id, prt 0 arrbrs])
    Ass id expr -> prPrec i 0 (concatD [prt 0 id, doc (showString "="), prt 0 expr, doc (showString ";")])
    AssArr id arrbrs expr -> prPrec i 0 (concatD [prt 0 id, prt 0 arrbrs, doc (showString "="), prt 0 expr, doc (showString ";")])
...
instance Print ArrBr where
  prt i e = case e of
    ArrBrac expr -> prPrec i 0 (concatD [doc (showString "["), prt 0 expr, doc (showString "]")])
  prtList _ [x] = concatD [prt 0 x]
  prtList _ (x:xs) = concatD [prt 0 x, prt 0 xs]
...
instance Print Type where
  prt i e = case e of
    ...
    Func type_ types -> prPrec i 0 (concatD [prt 0 type_, doc (showString "("), prt 0 types, doc (showString ")")])
  prtList _ [x] = concatD [prt 0 x]
  prtList _ (x:xs) = concatD [prt 0 x, doc (showString ","), prt 0 xs]
...
instance Print Expr where
  prt i e = case e of
    Lambda type_ args block -> prPrec i 6 (concatD [prt 0 type_, doc (showString "("), prt 0 args, doc (showString ")"), doc (showString "=>"), prt 0 block])
    ...
    EArr id arrbrs -> prPrec i 6 (concatD [prt 0 id, prt 0 arrbrs])
